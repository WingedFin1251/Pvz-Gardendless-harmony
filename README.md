...
| 上游 Release 的 HAP | 从上游 [Release](https://github.com/WingedFin1251/Pvz-Gardendless-harmony/releases) 页面下载。注意上游 HAP 的包名 / 应用名是 `Gardendless`，与本应用的 `com.gardendless.gpnext` **不同**，因此两者可共存、但无法互相覆盖安装 |
